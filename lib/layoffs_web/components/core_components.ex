defmodule LayoffsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LayoffsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LayoffsWeb.Gettext, "errors", msg, opts)
    end
  end
